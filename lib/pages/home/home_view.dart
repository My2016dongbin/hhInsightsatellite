...
class HomePage extends StatelessWidget {
        ...
        Container(
          ...
          child: SizedBox(
            ...
            child: AMapWidget(
              ...
              mapType: logic.mapTypeTag.value == 3
                  ? MapType.normal
                  : MapType.satellite,
              tiltGesturesEnabled: logic.mapChangeTag.value == 3,
              buildingsEnabled: logic.mapChangeTag.value == 3,
              compassEnabled: true,
              scaleEnabled: true,
            ...
            child: Column(
              children: [
                BouncingWidget(
                    ...
                    child: Image.asset(
                      'assets/images/common/ic_set.png',
                      width: 55.w * 3,
                      height: 55.w * 3,
                      fit: BoxFit.fill,
                    )),
                ...
                BouncingWidget(
                    ...
                    child: Image.asset(
                      'assets/images/common/ic_list.png',
                      width: 55.w * 3,
                      height: 55.w * 3,
                      fit: BoxFit.fill,
                    )),
                ...
                BouncingWidget(
                    ...
                    child: Image.asset(
                      'assets/images/common/ic_search.png',
                      width: 55.w * 3,
                      height: 55.w * 3,
                      fit: BoxFit.fill,
                    )),
                ...
                BouncingWidget(
                    ...
                    child: Image.asset(
                      'assets/images/common/ic_tuceng.png',
                      width: 55.w * 3,
                      height: 55.w * 3,
                      fit: BoxFit.fill,
                    )),
                ...
                BouncingWidget(
                    ...
                    child: Image.asset(
                      'assets/images/common/ic_refresh.png',
                      width: 55.w * 3,
                      height: 55.w * 3,
                      fit: BoxFit.fill,
                    )),
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "图层切换",
              style:
                  TextStyle(color: HhColors.titleColor_33, fontSize: 14.sp * 3),
            ),
          ),
          Row(
            children: [
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          logic.mapTypeTag.value == 3
                              ? "assets/images/common/ic_tdt_sl_select.png"
                              : "assets/images/common/ic_tdt_sl.png",
                          height: 0.16.sw,
                          fit: BoxFit.fill,
                        ),
                        SizedBox(
                        ...
                        Text(
                          "天地图矢量",
                          style: TextStyle(
                              color: logic.mapTypeTag.value == 3
                                  ? HhColors.themeColor
                                  : HhColors.titleColor_33,
                              fontSize: 12.sp * 3),
                        )
                      ],
                    ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          logic.mapTypeTag.value == 4
                              ? "assets/images/common/ic_tdt_yx_select.png"
                              : "assets/images/common/ic_tdt_yx.png",
                          height: 0.16.sw,
                          fit: BoxFit.fill,
                        ),
                        SizedBox(
                        ...
                        Text(
                          "天地图影像",
                          style: TextStyle(
                              color: logic.mapTypeTag.value == 4
                                  ? HhColors.themeColor
                                  : HhColors.titleColor_33,
                              fontSize: 12.sp * 3),
                        )
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          logic.mapChangeTag.value == 2
                              ? "assets/images/common/ic_2d_select.png"
                              : "assets/images/common/ic_2d.png",
                          height: 0.16.sw,
                          fit: BoxFit.fill,
                        ),
                        SizedBox(
                        ...
                        Text(
                          "二维地图",
                          style: TextStyle(
                              color: logic.mapChangeTag.value == 2
                                  ? HhColors.themeColor
                                  : HhColors.titleColor_33,
                              fontSize: 12.sp * 3),
                        )
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          logic.mapChangeTag.value == 3
                              ? "assets/images/common/ic_3d_select.png"
                              : "assets/images/common/ic_3d.png",
                          height: 0.16.sw,
                          fit: BoxFit.fill,
                        ),
                        SizedBox(
                        ...
                        Text(
                          "三维地图",
                          style: TextStyle(
                              color: logic.mapChangeTag.value == 3
                                  ? HhColors.themeColor
                                  : HhColors.titleColor_33,
                              fontSize: 12.sp * 3),
                        )
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Get.back();
                      logic.startTime.value = CommonUtils().parseLongTimeLong(
                          DateTime.now()
                              .subtract(const Duration(minutes: 10))
                              .millisecondsSinceEpoch);
                      logic.endTime.value = CommonUtils().parseLongTimeLong(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        ...
                        '当前时间',
                        style: TextStyle(
                            color: HhColors.blackColor, fontSize: 14.sp * 3),
                      )),
                    ),
                  ),
                  Container(
        ...
        builder: (a) {
          return Obx(() => Container(
                ...
                decoration: BoxDecoration(
                    color: HhColors.whiteColor,
                    borderRadius:
                        BorderRadius.vertical(top: Radius.circular(0.w))),
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          logic.satelliteStatus.value
                              ? Expanded(
                                  child: Wrap(
                                  children: buildSatelliteItems(),
                                ))
                              : const SizedBox()
                        ],
                      ),
              ...
              SizedBox(height: 10.w*3,),*/
                                ...
                                onTap: () {
                                  DatePicker.showDatePicker(Get.context!,
                                    ...
                                    DatePicker.showTimePicker(Get.context!,
                                        showTitleActions: true,
                                        onConfirm: (date) {
                                      logic.startTime.value = CommonUtils()
                                          .parseLongTime(
                                ...
                                onTap: () {
                                  DatePicker.showDatePicker(Get.context!,
                                    ...
                                    DatePicker.showTimePicker(Get.context!,
                                        showTitleActions: true,
                                        onConfirm: (date) {
                                      logic.endTime.value = CommonUtils()
                                          .parseLongTime(
                                              "${date.millisecondsSinceEpoch}");
                                    },
                                        currentTime: date,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          logic.landTypeStatus.value
                              ? Expanded(
                                  child: Wrap(
                                  children: buildLandTypeItems(),
                                ))
                              : const SizedBox()
                        ],
                      ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Image.asset(
                                                'assets/images/common/ic_down.png',
                                                width: 6.w * 3,
                                                height: 6.w * 3,
                                                fit: BoxFit.fill,
                                              )
                                        ...
                                        ? BouncingWidget(
                                            ...
                                            child: Container(
                                              ...
                                              padding: EdgeInsets.fromLTRB(
                                                  ...
                                                  3.w * 3),
                                              decoration: BoxDecoration(
                                                  color: logic.otherOut.value
                                                      ? HhColors.themeColor
                                                      : HhColors.blueEAColor,
                                                  borderRadius:
    ...
    for (int i = 0; i < logic.satelliteList.length; i++) {
      ...
      widgets.add(BouncingWidget(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color:
                  model["choose"] ? HhColors.themeColor : HhColors.blueEAColor,
  ...
  void chooseProvince() {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.scrollControllerP =
            FixedExtentScrollController(initialItem: logic.provinceIndex.value);
              ...
              Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    child: Container(
                        padding: EdgeInsets.fromLTRB(
                            15.w * 3, 10.w * 3, 0, 15.w * 3),
                        child: Icon(
                          Icons.clear,
                          color: HhColors.titleColor_99,
                          size: 20.w * 3,
                        )),
                    onTap: () {
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      if (logic.provinceList[index]["level"] == 0 &&
                          logic.provinceList[index]["name"] == "中国") {
                      ...
                      ///选择了境外数据
                      if (logic.provinceList[index]["level"] == 0 &&
                          logic.provinceList[index]["name"] == "境外") {
                        logic.provinceIndex.value = index;
                        logic.province.value = logic
                            .provinceList[logic.provinceIndex.value]["name"];
                        logic.provinceCode =
                            logic.provinceList[logic.provinceIndex.value]
                                ["areaCode"];
                        Navigator.pop(context);
                      ...
                      if (logic.provinceList[index]["level"] == 3) {
                        ...
                        logic.streetList = [];
                        logic.getStreet(
                            logic.provinceList[index]["areaCode"]); //

                        logic.provinceIndex.value = index; //
                        logic.area.value = logic
                            .provinceList[logic.provinceIndex.value]["name"]; //
                        logic.areaCode =
                            logic.provinceList[logic.provinceIndex.value]
                                ["areaCode"]; //
  ...
  void chooseProvinceMore(int indexMore) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.gridSearchList[indexMore]["scrollControllerP"] =
            FixedExtentScrollController(
                initialItem: logic.gridSearchList[indexMore]["provinceIndex"]);
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: ScrollConfiguration(
                    behavior: HhBehavior(),
                    child: CupertinoPicker(
                      scrollController: logic.gridSearchList[indexMore]
                          ["scrollControllerP"],
                      itemExtent: 45,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                              ["areaCode"] ==
                          "999") {
                      ...
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                              ["level"] ==
                          0) {
                        logic.getCountryMore(
                            logic.gridSearchList[indexMore]["provinceList"]
                                [index]["areaCode"],
                            indexMore);
                        Navigator.pop(context);
                      ...
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                        ...
                        logic.gridSearchList[indexMore]["provinceIndex"] =
                            index;
                        logic.gridSearchList[indexMore]["province"] =
                            logic.gridSearchList[indexMore]["provinceList"][
                                logic.gridSearchList[indexMore]
                                    ["provinceIndex"]]["name"];
                        logic.gridSearchList[indexMore]["provinceCode"] =
                            logic.gridSearchList[indexMore]["provinceList"][
                                logic.gridSearchList[indexMore]
                                    ["provinceIndex"]]["areaCode"];
                        Navigator.pop(context);
                      ...
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                        ...
                        logic.gridSearchList[indexMore]["provinceIndex"] =
                            index; //
                        logic.gridSearchList[indexMore]["city"] =
                            logic.gridSearchList[indexMore]["provinceList"][
                                logic.gridSearchList[indexMore]
                                    ["provinceIndex"]]["name"]; //
                        logic.gridSearchList[indexMore]["cityCode"] =
                      ...
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                        ...
                        logic.gridSearchList[indexMore]["provinceIndex"] =
                            index; //
                        logic.gridSearchList[indexMore]["area"] =
                            logic.gridSearchList[indexMore]["provinceList"][
                                logic.gridSearchList[indexMore]
                                    ["provinceIndex"]]["name"]; //
                        logic.gridSearchList[indexMore]["areaCode"] =
                      ...
                      if (logic.gridSearchList[indexMore]["provinceList"][index]
                        ...
                        logic.gridSearchList[indexMore]["provinceIndex"] =
                            index; //
                        logic.gridSearchList[indexMore]["street"] =
                            logic.gridSearchList[indexMore]["provinceList"][
                                logic.gridSearchList[indexMore]
                                    ["provinceIndex"]]["name"]; //
                        logic.gridSearchList[indexMore]["streetCode"] =
  ...
  void chooseCity() {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.scrollControllerC =
            FixedExtentScrollController(initialItem: logic.cityIndex.value);
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      logic.city.value =
                          logic.cityList[logic.cityIndex.value]["name"];
                      logic.cityCode =
                          logic.cityList[logic.cityIndex.value]["areaCode"];
                      Navigator.pop(context);
  ...
  void chooseCityMore(int indexMore) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.gridSearchList[indexMore]["scrollControllerC"] =
            FixedExtentScrollController(
                initialItem: logic.gridSearchList[indexMore]["cityIndex"]);
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      if (logic.gridSearchList[indexMore]["cityList"][index]
                              ["areaCode"] ==
                          "999") {
                        logic.gridSearchList[indexMore]["areaList"] = [];
                        logic.gridSearchList[indexMore]["streetList"] = [];
                      ...
                      logic.gridSearchList[indexMore]["areaList"] = [];
                      logic.getAreaMore(
                          logic.gridSearchList[indexMore]["cityList"][index]
                              ["areaCode"],
                          indexMore);
                      ...
                      logic.gridSearchList[indexMore]["city"] =
                          logic.gridSearchList[indexMore]["cityList"]
                                  [logic.gridSearchList[indexMore]["cityIndex"]]
                              ["name"];
                      logic.gridSearchList[indexMore]["cityCode"] =
                          logic.gridSearchList[indexMore]["cityList"]
                                  [logic.gridSearchList[indexMore]["cityIndex"]]
  ...
  void chooseArea() {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.scrollControllerA =
            FixedExtentScrollController(initialItem: logic.areaIndex.value);
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      logic.area.value =
                          logic.areaList[logic.areaIndex.value]["name"];
                      logic.areaCode =
                          logic.areaList[logic.areaIndex.value]["areaCode"];
                      Navigator.pop(context);
  ...
  void chooseAreaMore(int indexMore) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.gridSearchList[indexMore]["scrollControllerA"] =
            FixedExtentScrollController(
                initialItem: logic.gridSearchList[indexMore]["areaIndex"]);
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      if (logic.gridSearchList[indexMore]["areaList"][index]
                              ["areaCode"] ==
                          "999") {
                        logic.gridSearchList[indexMore]["streetList"] = [];
                        logic.gridSearchList[indexMore]["area"] = "请选择区";
                      ...
                      logic.gridSearchList[indexMore]["streetList"] = [];
                      logic.getStreetMore(
                          logic.gridSearchList[indexMore]["areaList"][index]
                              ["areaCode"],
                          indexMore);
                      ...
                      logic.gridSearchList[indexMore]["area"] =
                          logic.gridSearchList[indexMore]["areaList"]
                                  [logic.gridSearchList[indexMore]["areaIndex"]]
                              ["name"];
                      logic.gridSearchList[indexMore]["areaCode"] =
                          logic.gridSearchList[indexMore]["areaList"]
                                  [logic.gridSearchList[indexMore]["areaIndex"]]
  ...
  void chooseStreet() {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.scrollControllerS =
            FixedExtentScrollController(initialItem: logic.streetIndex.value);
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      logic.street.value =
                          logic.streetList[logic.streetIndex.value]["name"];
                      logic.streetCode =
                          logic.streetList[logic.streetIndex.value]["areaCode"];
                      Navigator.pop(context);
                    },
                  ),
                ],
  ...
  void chooseStreetMore(int indexMore) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        logic.gridSearchList[indexMore]["scrollControllerS"] =
            FixedExtentScrollController(
                initialItem: logic.gridSearchList[indexMore]["streetIndex"]);
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      if (logic.gridSearchList[indexMore]["streetList"][index]
                              ["areaCode"] ==
                          "999") {
                        logic.gridSearchList[indexMore]["street"] = "请选择街道";
                        logic.gridSearchList[indexMore]["streetCode"] = "";
                      ...
                      logic.gridSearchList[indexMore]["street"] = logic
                                  .gridSearchList[indexMore]["streetList"]
                              [logic.gridSearchList[indexMore]["streetIndex"]]
                          ["name"];
                      logic.gridSearchList[indexMore]["streetCode"] = logic
                                  .gridSearchList[indexMore]["streetList"]
                              [logic.gridSearchList[indexMore]["streetIndex"]]
                          ["areaCode"];
                      Navigator.pop(context);
  ...
  getProvince() {
    ...
    for (int i = 0; i < logic.provinceList.length; i++) {
      list.add(Container(
        ...
        child: Center(
            child: Text(
          logic.provinceList[i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic.provinceList[i]["name"].length > 3
                  ? 14.sp * 3
                  : 15.sp * 3),
        )),
      ));
  ...
  getProvinceMore(int indexMore) {
    List<Widget> list = [];
    for (int i = 0;
        i < logic.gridSearchList[indexMore]["provinceList"].length;
        i++) {
      list.add(Container(
        color: HhColors.trans,
        child: Center(
            child: Text(
          logic.gridSearchList[indexMore]["provinceList"][i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic
                          .gridSearchList[indexMore]["provinceList"][i]["name"]
                          .length >
                      3
                  ? 14.sp * 3
                  : 15.sp * 3),
  ...
  getCity() {
    ...
    for (int i = 0; i < logic.cityList.length; i++) {
      list.add(Container(
        ...
        child: Center(
            child: Text(
          logic.cityList[i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize:
                  logic.cityList[i]["name"].length > 3 ? 14.sp * 3 : 15.sp * 3),
        )),
      ));
    }
    return list;
  ...
  getCityMore(int indexMore) {
    List<Widget> list = [];
    for (int i = 0;
        i < logic.gridSearchList[indexMore]["cityList"].length;
        i++) {
      list.add(Container(
        color: HhColors.trans,
        child: Center(
            child: Text(
          logic.gridSearchList[indexMore]["cityList"][i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic.gridSearchList[indexMore]["cityList"][i]["name"]
                          .length >
                      3
                  ? 14.sp * 3
                  : 15.sp * 3),
  ...
  getArea() {
    ...
    for (int i = 0; i < logic.areaList.length; i++) {
      list.add(Container(
        ...
        child: Center(
            child: Text(
          logic.areaList[i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize:
                  logic.areaList[i]["name"].length > 3 ? 14.sp * 3 : 15.sp * 3),
        )),
      ));
    }
    return list;
  ...
  getAreaMore(int indexMore) {
    List<Widget> list = [];
    for (int i = 0;
        i < logic.gridSearchList[indexMore]["areaList"].length;
        i++) {
      list.add(Container(
        color: HhColors.trans,
        child: Center(
            child: Text(
          logic.gridSearchList[indexMore]["areaList"][i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic.gridSearchList[indexMore]["areaList"][i]["name"]
                          .length >
                      3
                  ? 14.sp * 3
                  : 15.sp * 3),
  ...
  getStreet() {
    ...
    for (int i = 0; i < logic.streetList.length; i++) {
      list.add(Container(
        ...
        child: Center(
            child: Text(
          logic.streetList[i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic.streetList[i]["name"].length > 3
                  ? 14.sp * 3
                  : 15.sp * 3),
        )),
      ));
  ...
  getStreetMore(int indexMore) {
    List<Widget> list = [];
    for (int i = 0;
        i < logic.gridSearchList[indexMore]["streetList"].length;
        i++) {
      list.add(Container(
        color: HhColors.trans,
        child: Center(
            child: Text(
          logic.gridSearchList[indexMore]["streetList"][i]["name"],
          style: TextStyle(
              color: HhColors.blackColor,
              fontSize: logic.gridSearchList[indexMore]["streetList"][i]["name"]
                          .length >
                      3
                  ? 14.sp * 3
                  : 15.sp * 3),
  ...
  void reset() {
    ...
    logic.startTime.value = CommonUtils().parseLongTimeLong(DateTime.now()
        .subtract(const Duration(hours: 3))
        .millisecondsSinceEpoch);
    logic.endTime.value =
        CommonUtils().parseLongTimeLong(DateTime.now().millisecondsSinceEpoch);
    logic.province.value = "请选择省";
    logic.provinceCode = "";
    logic.provinceIndex.value = 0;
    logic.city.value = "请选择市";
          ...
          children: [
            ...
            BouncingWidget(
              ...
              child: Container(
                ...
                padding:
                    EdgeInsets.fromLTRB(15.w * 3, 10.w * 3, 10.w * 3, 10.w * 3),
                child: Container(
                  width: 16.w * 3,
                  height: 16.w * 3,
                  alignment: Alignment.center,
