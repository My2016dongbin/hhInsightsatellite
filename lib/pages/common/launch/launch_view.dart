...
class LaunchPage extends StatelessWidget {
  ...
  launchView() {
    return Stack(
      children: [
        CommonData.personal?SizedBox(height: 1.sh,width: 1.sw,child: Image.asset('assets/images/common/ic_yd.png',fit: BoxFit.fill,)):const SizedBox(),
            ...
            margin: EdgeInsets.only(top: 181.h*3),
              child: Column(
                ...
                children: [
                  ...
                  Text('慧眼卫星',style: TextStyle(color: HhColors.whiteColor,fontSize: 16.sp*3),)
                ],
              )
          ),
        ),*/
